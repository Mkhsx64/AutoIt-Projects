...
Global $sAu3SH_Funcs_URL =  __Au3_SyntaxHighlight_PropertyRead($sAu3_Keywords_File, "au3.keywords.functions.url", "http://www.autoitscript.com/autoit3/docs/functions/%s.htm", 0)
Global $sAu3SH_UDFs_URL = __Au3_SyntaxHighlight_PropertyRead($sAu3_Keywords_File, "au3.keywords.udfs.url", "http://www.autoitscript.com/autoit3/docs/libfunctions/%s.htm", 0)
Global $sAu3SH_Keywords_URL = __Au3_SyntaxHighlight_PropertyRead($sAu3_Keywords_File, "au3.keywords.keywotds.url", "http://www.autoitscript.com/autoit3/docs/keywords.htm#%s", 0)
Global $sAu3SH_Macros_URL = __Au3_SyntaxHighlight_PropertyRead($sAu3_Keywords_File, "au3.keywords.macros.url", "http://www.autoitscript.com/autoit3/docs/macros.htm#%s", 0)
Global $sAu3SH_PreProcessor_URL = __Au3_SyntaxHighlight_PropertyRead($sAu3_Keywords_File, "au3.keywords.preprocessor.url", "http://www.autoitscript.com/autoit3/docs/keywords.htm#%s", 0)
Global Enum $iAu3SH_WSpace_Style = 0, $iAu3SH_Cmnt_Style, $iAu3SH_CmntBlck_Style, $iAu3SH_Nmbr_Style, $iAu3SH_Fnc_Style, $iAu3SH_Kwd_Style, $iAu3SH_Mcro_Style, $iAu3SH_Str_Style, $iAu3SH_Oprtr_Style, $iAu3SH_Var_Style, $iAu3SH_SntKys_Style, $iAu3SH_PrPrc_Style, $iAu3SH_Spec_Style, $iAu3SH_Abrv_Style, $iAu3SH_COM_Style, $iAu3SH_Udf_Style
...
Local $sUnique_Str_Include = '!~@%@~!'
Local $sUnique_Str_CmntBlk = '%~@%@~%'
...
EndIf
WEnd
While StringInStr($sAu3Code, $sUnique_Str_CmntBlk)
$sUnique_Str_CmntBlk &= Random(10000, 99999)
If $iAu3SH_AbortHighlight = 1 Then
Return SetError(-1, 0, $sOrigin_Au3Code)
EndIf
WEnd
...
$sAu3Code = StringReplace($sAu3Code, $aCmntBlk_Strings[$i], $sUnique_Str_CmntBlk)
Next
$sPattern1 = '(?m)(("|'')[^\2\r\n]*?\2)'
...
$sAu3Code = StringRegExpReplace($sAu3Code, $sPattern1, $sReplace1)
__Au3_SyntaxHighlight_Debug_RegExp_Patterns("", $sPattern1, $sReplace1, "Highlight the COM Objects (""S8"" is the highlight for operators, here it is a dot (.) char)", $sAu3Code, @ScriptLineNumber - 2)
__Au3_SyntaxHighlight_Debug_RegExp_Patterns("===")
$sPattern1 = '([^\w#@])(\d+)([^\w])'
...
$sAu3Code = StringReplace($sAu3Code, $sUnique_Str_CmntBlk, $aAu3SH_Styles[$iAu3SH_CmntBlck_Style] & $aCmntBlk_Strings[$i] & $sAu3SH_CloseTag, 1)
If $iAu3SH_AbortHighlight = 1 Then
Return SetError(-1, 0, $sOrigin_Au3Code)
EndIf
Next
...
Next
Do
$sAu3Code = StringRegExpReplace($sAu3Code, '(.*?(?:' & $aAu3SH_Styles[$iAu3SH_Cmnt_Style] & ';|' & $aAu3SH_Styles[$iAu3SH_Spec_Style] & '#).*?)' & '(?:' & $aAu3SH_Styles[$iAu3SH_Str_Style] & '|' & $aAu3SH_Styles[$iAu3SH_SntKys_Style] & '|' & $aAu3SH_Styles[$iAu3SH_Var_Style] & ')(.*?)' & $sAu3SH_CloseTag & '(.*?)', '\1\2\3')
Until @extended = 0
$sAu3Code = StringReplace($sAu3Code, @TAB, '    ')
If $iDebug_RegExp_WriteLog Then
Local $hFile = FileOpen($sDebug_RegExp_LogFile, 1)
FileWrite($hFile, StringFormat('_Au3_SyntaxHighlight Debug RegExp Log started at: %.2i/%.2i/%i, %.2i:%.2i:%.2i\r\n' & '~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~\r\n%s\r\n', @MDAY, @MON, @YEAR, @HOUR, @MIN, @SEC, $sDebug_RegExp_LogContent) & '~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~' & @CRLF)
FileClose($hFile)
EndIf
...
$iLineNum = @ScriptLineNumber - 3
EndIf
__Au3_SyntaxHighlight_Debug_RegExp_Patterns("", $sPattern1, $sReplace1, "Highlight built-in functions - The function name/url in the <Search/Replace Pattern> is the last found name/url in the functions list (after the loop ends)", $sAu3Code, $iLineNum)
__Au3_SyntaxHighlight_Debug_RegExp_Patterns("===")
Return $sAu3Code
EndFunc
...
$iLineNum = @ScriptLineNumber - 3
EndIf
__Au3_SyntaxHighlight_Debug_RegExp_Patterns("", $sPattern1, $sReplace1, "Highlight the UDFs - The UDF name/url in the <Search/Replace Pattern> is the last found name/url in the UDFs list (after the loop ends)", $sAu3Code, $iLineNum)
__Au3_SyntaxHighlight_Debug_RegExp_Patterns("===")
Return $sAu3Code
EndFunc
...
$iLineNum = @ScriptLineNumber - 3
EndIf
__Au3_SyntaxHighlight_Debug_RegExp_Patterns("", $sPattern1, $sReplace1, "Highlight the Keywords - The Keyword name/url in the <Search/Replace Pattern> is the last found name/url in the Keywords list (after the loop ends)", $sAu3Code, $iLineNum)
__Au3_SyntaxHighlight_Debug_RegExp_Patterns("===")
Return $sAu3Code
EndFunc
...
$iLineNum = @ScriptLineNumber - 3
EndIf
__Au3_SyntaxHighlight_Debug_RegExp_Patterns("", $sPattern1, $sReplace1, "Highlight the Macros - The Macro name/url in the <Search/Replace Pattern> is the last found name/url in the Macros list (after the loop ends)", $sAu3Code, $iLineNum)
__Au3_SyntaxHighlight_Debug_RegExp_Patterns("===")
Return $sAu3Code
EndFunc
...
$sReplace1 = '\1\2\3'
$sReplace2 = '\1<a href="' & StringFormat($sAu3SH_PreProcessor_URL, $aPreProcessor[$i]) & '">' & $aAu3SH_Styles[$iAu3SH_PrPrc_Style] & '\2' & $sAu3SH_CloseTag & '</a>\3'
Do
$sAu3Code = StringRegExpReplace($sAu3Code, $sPattern1, $sReplace1)
Until @extended = 0
$sAu3Code = StringRegExpReplace($sAu3Code, $sPattern2, $sReplace2)
...
$iLineNum = @ScriptLineNumber - 3
EndIf
__Au3_SyntaxHighlight_Debug_RegExp_Patterns("", $sPattern1, $sReplace1, "Highlight the PreProcessor - The PreProc. name/url in the <Search/Replace Pattern> is the last found name/url in the PreProc. list (after the loop ends)", $sAu3Code, $iLineNum)
__Au3_SyntaxHighlight_Debug_RegExp_Patterns("===")
Return $sAu3Code
EndFunc
...
__Au3_SyntaxHighlight_Debug_RegExp_Patterns("b", $sPattern2, $sReplace2, "Highlight Special Keywords - The Spec. keywords name in the <Search Pattern> is the last found name in the Spec. keywords list (after the loop ends)", $sAu3Code, @ScriptLineNumber - 4)
__Au3_SyntaxHighlight_Debug_RegExp_Patterns("===")
Return $sAu3Code
EndFunc
...
__Au3_SyntaxHighlight_Debug_RegExp_Patterns("b", $sPattern2, $sReplace2, "Highlight send keys - The send key name in the <Search Pattern> is the last found name in the send keys list (after the loop ends)", $sStrings, @ScriptLineNumber-3)
__Au3_SyntaxHighlight_Debug_RegExp_Patterns("===")
...
$sPattern1 = '(\s+)?([^(&lt|&gt)]|\h+?|^);'
$sPattern2 = '<\w+\h?[^>]*?>(.*?)</\w+>'
$sPattern3 = '(?i)(\s+)?#(cs|comments.*?start)(.*)'
$sPattern4 = '(?i)(\s+)?#(ce|comments.*?end)(.*)'
$sPattern5 = '(?i)(?<=(<span class="au3_S\d">))(?>(.*?)</span>)( *)\1|(?<=(<span class="au3_S\d\d">))(?>(.*?)</span>)( *)\4'
$sReplace2 = '\1'
...
__Au3_SyntaxHighlight_Debug_RegExp_Patterns("b", $sPattern2, '', "Remove all tags pattern", $sAu3Code, @ScriptLineNumber + 19 & "/" & @ScriptLineNumber + 24 & "/" & @ScriptLineNumber + 36)
__Au3_SyntaxHighlight_Debug_RegExp_Patterns("c", $sPattern3, "Check mathes (flag [0] in StringRegExp) / " & $sReplace3, "#comment-start search pattern", $sAu3Code, @ScriptLineNumber + 20 & '/' & @ScriptLineNumber + 25 & "/" & @ScriptLineNumber + 38)
__Au3_SyntaxHighlight_Debug_RegExp_Patterns("d", $sPattern4, "", "#comment-end search pattern" & @CRLF & @CRLF & "! Summary:		Highlight commented lines / comment block", $sAu3Code, @ScriptLineNumber + 41 & "/" & @ScriptLineNumber + 46)
__Au3_SyntaxHighlight_Debug_RegExp_Patterns("===")
...
$sCmmntsEnd = 'ce'
If StringRegExp($aSplit_Code[$i], '(?i)^\h*#comments-start') Then $sCmmntsEnd = 'comments-end'
$sCmntBlk &= $aSplit_Code[$i] & @CRLF
For $j = $i+1 To $aSplit_Code[0]
If StringRegExp($aSplit_Code[$j], '(?i)^\h*#(cs|comments-start)') Then
$iSubCmntOpen = 1
$sSubCmntEnd = 'ce'
If StringRegExp($aSplit_Code[$j], '(?i)^\h*#comments-start') Then $sSubCmntEnd = 'comments-end'
EndIf
...
EndIf
Local $sRet = '<head>' & @CRLF & '<style type="text/css">' & @CRLF & @CRLF & '.au3_codebox' & @CRLF & '{' & @CRLF & '	BORDER-BOTTOM: #AAAAAA 1px solid;' & @CRLF & '	BORDER-LEFT: #AAAAAA 1px solid;' & @CRLF & '	BORDER-RIGHT: #AAAAAA 1px solid;' & @CRLF & '	BORDER-TOP: #AAAAAA 1px solid;' & @CRLF & '	PADDING-RIGHT: 8px;' & @CRLF & '	PADDING-LEFT: 8px;' & @CRLF & '	PADDING-BOTTOM: 8px;' & @CRLF & '	PADDING-TOP: 8px;' & @CRLF & '	FONT-SIZE: 12px;' & @CRLF & '	FONT-FAMILY: Courier New, Verdana, Courier, Arial;' & @CRLF & '	FONT-WEIGHT: ' & $sFontWeight & ';' & @CRLF & '	BACKGROUND-COLOR: ' & $sFontBkColor & ';' & @CRLF & '	COLOR: ' & $sFontColor & ';' & @CRLF & '	WHITE-SPACE: pre;' & @CRLF & '}' & @CRLF & @CRLF & 'a' & @CRLF & '{' & @CRLF & '	text-decoration:none;' & @CRLF & '}' & @CRLF & @CRLF & 'a:hover' & @CRLF & '{' & @CRLF & '	text-decoration:underline;' & @CRLF & '}' & @CRLF & @CRLF & 'pre' & @CRLF & '{' & @CRLF & '	font-family: Verdana, Arial, Helvetica, sans-serif, "MS sans serif";' & @CRLF & '	line-height: normal;' & @CRLF & '	margin-top: 0.5em;' & @CRLF & '	margin-bottom: 0.5em;' & @CRLF & '}' & @CRLF & @CRLF & 'span' & @CRLF & '{' & @CRLF & '	font-family: ' & $sFontFamily & ';' & @CRLF & '	font-weight: ' & $sFontWeight & ';' & @CRLF & '	color: ' & $sFontColor & ';' & @CRLF & '}' & @CRLF & @CRLF
For $i = 0 To 15
If $iAu3SH_AbortHighlight = 1 Then
Return SetError(-1)
EndIf
...
$sAu3HtmlCode = StringRegExpReplace($sAu3HtmlCode, '(?si)(.*?)' & $aAu3SH_Styles[$i] & '(.*?)' & $sAu3SH_CloseTag & '(.*?)', '\1' & $sTags_Start & '\2' & $sTags_End & '\3')
...
Case $synHTML
If $htmlCount = 0 Then
$htmlCount = AdlibRegister("htmlSyn", 1000)
Else
AdlibUnRegister("htmlSyn")
$htmlCount = 0
EndIf
Case $fSave
Save()
...
EndFunc
Func htmlSyn()
Local $gHTMLcode, $gSel
If _GUICtrlRichEdit_GetTextLength($pEditWindow) = $au3Buffer Then Return
$gSel = _GUICtrlRichEdit_GetSel($pEditWindow)
$gHTMLcode = _Au3_SyntaxHighlight_Proc(_GUICtrlRichEdit_GetText($pEditWindow), 2)
_GUICtrlRichEdit_SetText($pEditWindow, $gHTMLcode)
