...
;### Tidy Error -> "endswitch" is closing previous "case" on line 143
				EndSwitch
			...
			Case $vhChild
				...
				EndSwitch
;### Tidy Error -> "endswitch" is closing previous "case" on line 141
		EndSwitch
		Sleep(10) ; added as the functions running every second are causing the window to twitch
;### Tidy Error -> "wend" is closing previous "switch" on line 140
	WEnd
